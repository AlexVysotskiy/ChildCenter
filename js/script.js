...
$document.ready(function() {
    ...
    if (plugins.rdMailForm.length) {
        var i, j, k, msg = {
            'MF000': 'Мы свяжемся с Вами в ближайшее время!',
            'MF001': 'Во время отправки произошли ошибки',
            'MF002': 'Во время отправки произошли ошибки',
            'MF003': 'Во время отправки произошли ошибки',
            'MF004': 'Во время отправки произошли ошибки',
            'MF254': 'Во время отправки произошли ошибки',
            'MF255': 'Во время отправки произошли ошибки'
        };
